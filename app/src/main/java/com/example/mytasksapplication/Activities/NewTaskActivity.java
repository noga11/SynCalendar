...
public class NewTaskActivity extends AppCompatActivity {
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.nav_Add) {
                    startActivity(new Intent(NewTaskActivity.this, NewTaskActivity.class));
                    return true;
                } else if (item.getItemId() == R.id.nav_Tasks) {
                    startActivity(new Intent(NewTaskActivity.this, AllTasksActivity.class));
                    return true;
                }
                return false;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_follow_request) {
            startActivity(new Intent(NewTaskActivity.this, FollowingActivity.class));
            return true;
        }
            ...
            startActivity(new Intent(NewTaskActivity.this, LoginActivity.class));
            return true;
        }
